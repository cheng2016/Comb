package com.cds.comb.util;

import android.os.Environment;
import android.os.Process;
import android.util.Log;

import com.cds.comb.App;
...
public class Logger {
    ...
    static {
        ...
        myPid = Process.myPid();
        if (isSDCardOK()) {
            defaultDir = Environment.getExternalStorageDirectory() + "/wecare/comb/logger/";
        } else {
            defaultDir = App.getInstance().getCacheDir().getAbsolutePath() + "/wecare/comb/logger";
        }
    }
